...
check("related learning sites in footer", "https://ayeduplan2.thamdee.com/" in (ROOT / "index.html").read_text(encoding="utf-8") and "https://sdg.thamdee.com/" in (ROOT / "index.html").read_text(encoding="utf-8"))
